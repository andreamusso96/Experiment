...
if is_cluster:
    EXPERIMENT_RESULT_BASE_FOLDER = '/cluster/project/coss/anmusso/Projects/Experiment/ExperimentResults'
    GRAPH_BASE_FOLDER = '/cluster/project/coss/anmusso/Projects/Experiment/Graphs'
else:
